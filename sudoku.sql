...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 05. Mai 2017 um 11:39
...
CREATE TABLE `spiele` (
  `SpielerID` int(10) NOT NULL,
  `gewSpiele` int(6) DEFAULT NULL,
  `gewSpieleLeicht` int(6) DEFAULT NULL,
  `gewSpieleMittel` int(6) DEFAULT NULL,
  `gewSpieleSchwer` int(6) DEFAULT NULL,
  `gewSpieleExtrem` int(6) DEFAULT NULL,
  ...
  `DuelleGew` int(6) DEFAULT NULL,
  `DuelleGes` int(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_german2_ci;
